<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl fixed-start ms-3"
    id="sidenav-main"
    style="position: fixed; top: 1.5rem; bottom: 1.5rem; height: auto; overflow-y: auto; max-height: none;">
    <div class="sidenav-header">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            aria-hidden="true" id="iconSidenav"></i>
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img src="{{ asset('assets/img/logokenangan.png') }}" class="navbar-brand-img h-100" alt="...">
            <span class="ms-3 font-weight-bold">Kenangan Gift By Nadin Husna</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('product-management') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Product Management nadin</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ Request::is('ROI-management') ? 'active' : '' }}"
                    href="{{ url('ROI-management') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">ROI Management nadin</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ Request::is('receipt-management*') ? 'active' : '' }}"
                    href="{{ route('receipt-management.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Receipt Management</span>
                </a>
            </li>
