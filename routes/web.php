...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('product-management/create', [ProductManagementController::class, 'create'])->name('product-management.create');
	Route::get('product-management/{product}/edit', [ProductManagementController::class, 'edit'])->name('product-management.edit');
	...
	Route::get('ROI-management', [App\Http\Controllers\ROIManagementController::class, 'index']);
